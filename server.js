...
var rollbar = new Rollbar({
  accessToken: "b6dcbe0606c14f02b6090b5e19addf83",
  captureUncaught: true,
  captureUnhandledRejections: true,
});

// record a generic message and send it to Rollbar
rollbar.log("I am Struggling");
rollbar.log("QA is not for me");
rollbar.log("Please help");
rollbar.log("I have a headache");
